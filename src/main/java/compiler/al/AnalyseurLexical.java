...
public class AnalyseurLexical {
    ...
    // les unités non terminals de l'analyseur lexicales sont les unités terminales
    // de l'analyseur synt
        ...
        if (this.fileReader.hasNext()) {
            ...
            if (uniteCourant.charAt(i) == '+') {
                if (i + 1 == uniteCourant.length())
                    ...
                    i++;
                    while (i < uniteCourant.length() && estChiffre(uniteCourant.charAt(i))) {
                        i++;
                    }
            ...
            // ac*1014a
                ...
                while (i < uniteCourant.length() && (estLettre(uniteCourant.charAt(i))
                        || estChiffre(uniteCourant.charAt(i)) || uniteCourant.charAt(i) == '_')) {
                    i++;
                }
